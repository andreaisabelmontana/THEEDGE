...
(function () {
  ...
  const DICT = {
    es: {
      ...
      'panel.projects.desc': 'Proyectos seleccionados, demos interactivas y las ideas detrás de cada uno.',
      ...
      'panel.about.desc': 'Investigación, estudios y los lugares que han dado forma a mi trabajo.',
      'cta.view': 'Ver',
    },
    de: {
      'nav.menu': 'Menü',
      ...
      'panel.projects.desc': 'Ausgewählte Projekte, interaktive Demos und die Gedanken dahinter.',
      ...
      'panel.about.desc': 'Forschung, Studium und die Orte, die meine Arbeit geprägt haben.',
      'cta.view': 'Ansehen',
    },
  };
  ...
  const PHRASES = {
    ...
    'Open to internships and roles for summer 2027 and fall 2027.': {
      es: 'Disponible para prácticas y empleo en verano de 2027 y otoño de 2027.',
      de: 'Offen für Praktika und Stellen im Sommer 2027 und Herbst 2027.',
    },
