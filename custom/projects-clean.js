(function () {
  ...
  function render() {
    ...
    cards.forEach(function(card){
      ...
      var typeLabel=project && ((project.typeLabels && project.typeLabels[lang])||project.typeLabel);
